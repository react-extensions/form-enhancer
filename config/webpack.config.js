...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        entry: [
            ...
            isEnvDevelopment ? paths.appIndexJs : paths.appCoreJs,
        ...
        output: {
            ...
            chunkFilename: isEnvProduction ?
                '[name].chunk.js' : isEnvDevelopment && 'static/js/[name].chunk.js',
        ...
        resolve: {
            ...
            alias: {
                ...
                '@icon': resolveApp('src/components/icon'),
                '@cn': resolveApp('src/app-lib/class-name')
            },
            plugins: [
